...
return {
conversation: 'WhatsApp Bot By zero'
}}
}
...
let teksnotif = `*IbzzBotzz V13* Berhasil Tersambung Ke Nomor WhatsApp ${Skyzo.user.id.split(":")[0]}`
Skyzo.sendMessage("6281585058824@s.whatsapp.net", {text: teksnotif})
