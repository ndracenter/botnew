...
switch (command) {
case "menu": case "dytz": case "dytzmenu": case "zeromenu": {
let teksnya = `
...
buttons: [{
"name": "single_select",
"buttonParamsJson": `{ "title": "List MENU Zero Cloud Hosting 😾", "sections": [{ "title": "# Pilih Salah Satu Menu Di Bawah Ini", "highlight_label": \"Powered By ${namaowner}\", "rows": [{ "header": "Allmenu", "title": "List All Fitur Bot", "id": ".allmenu" }, 
{ "header": "Mainmenu", "title": "List Main Menu😎", "id": ".mainmenu" }, 
{ "header": "Produkmenu", "title": "List Produk Zero Cloud Hosting 🚀", "id": ".produkmenu" }, 
...
{ "header": "Ownermenu", "title": "List Owner Menu☺️", "id": ".ownermenu" }]}]}`
}, 
{
"name": "cta_url",
...
let imgsc = await prepareWAMessageMedia({ image: await fs.readFileSync("./media/thumbnail.jpg") }, { upload: Ibzz.waUploadToServer })
...
text: `_*⚡ ALL TRX ON⚡*_
_*📦ALL BARANG READY📦*_`
}),
carouselMessage: proto.Message.InteractiveMessage.CarouselMessage.fromObject({
cards: [{
header: proto.Message.InteractiveMessage.Header.fromObject({
title: `__*List Market*_
*PROMO VPS DIGITAL OCEAN*

*FREE INSTALL*

*BISA UNTUK PO SERVER WHM&CPANEL DAN PTERODACTYL GASSKEN*

> 🛍️ RAM 1GB || CORE 1 = 15K
> 🛍️ RAM 2GB || CORE 1 = 25K
> 🛍️ RAM 2GB || CORE 2 = 35K
> 🛍️ RAM 4GB || CORE 2 = 55K
> 🛍️ RAM 8GB || CORE 4 = 75K
> 🛍️ RAM 16GB || CORE 4 = 125K

✅ STOCK TERBATAS
✅ activate 30 hari
✅ Full support admin 15hari
✅ Promo hanya berlaku sampai hari senin saja
Gassken di order
...
> _Jasa post ke pm_
---------------------------
Minat? Klik _*Chat Owner*_ di bawah`, 
...
║➣📡𝙍𝙖𝙢 16 𝘾𝙥𝙪 8
║➣📡𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝘼𝙡𝙡 𝙎𝙘𝙧𝙞𝙥𝙩
*║➣📡SUP WEBP BANK,SLOT DLL.*
▶️ 𝗢𝗿𝗱𝗲𝗿? 𝗟𝗮𝗻𝗴𝘀𝘂𝗻𝗴 𝗖𝗵𝗮𝘁
🪀𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱: 6283842088718
`, 
hasMediaAttachment: true,
...imgsc
}),
...
{
header: proto.Message.InteractiveMessage.Header.fromObject({
title: `_*List Panel Bot WhatsApp By ZERO CLOUD HOSTING 🦅*_
...
{
header: proto.Message.InteractiveMessage.Header.fromObject({
title: `_*GRUP Hosting bebas share link*_
 https://chat.whatsapp.com/ECrsnoYgev65WFpFeX7JXJ
 
_*GRUP² ()*_
belum tersedia

_*TERBUKA BEBAS SHARE*_
https://chat.whatsapp.com/ECrsnoYgev65WFpFeX7JXJ

_*TESTI (SETIAP HARI UP TESTIMONI)*_
BELUM TERSEDIA`, 
hasMediaAttachment: true,
...imgsc
}),
...
try {
await Ibzz.relayMessage(jid, msgii.message, {messageId: msgii.key.id})
total += 1
} catch {}
...
break
case "list_vps": {
let teks = `*DytzzStore ⚡ MENYEDIAKAN*
